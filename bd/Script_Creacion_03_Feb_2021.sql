...
-- -----------------------------------------------------
-- Table `bdconectate`.`cat_navegacion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bdconectate`.`cat_navegacion` ;

CREATE TABLE IF NOT EXISTS `bdconectate`.`cat_navegacion` (
  `id_cat_navegacion` INT NOT NULL AUTO_INCREMENT,
  `grupo` INT NOT NULL,
  `nivel` INT NOT NULL,
  `hijo` VARCHAR(150) NULL,
  `id` VARCHAR(150) NULL,
  ...
  `external_link` TINYINT(1) NULL,
  `exact_match` TINYINT(1) NULL,
  `classes` VARCHAR(150) NULL,
  `icon` VARCHAR(150) NULL,
  `icon_classes` VARCHAR(150) NULL,
  `badge_title` VARCHAR(150) NULL,
  `badge_style` VARCHAR(150) NULL,
  `badge_background` VARCHAR(150) NULL,
  `badge_color` VARCHAR(150) NULL,
  `meta` VARCHAR(150) NULL,
  `ctrl_fecha_create` DATETIME NULL,
  `ctrl_fecha_update` DATETIME NOT NULL,
  `ctrl_user_mod` INT NOT NULL,
  PRIMARY KEY (`id_cat_navegacion`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `bdconectate`.`navegacion_roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bdconectate`.`navegacion_roles` ;

CREATE TABLE IF NOT EXISTS `bdconectate`.`navegacion_roles` (
  `id_navegacion_roles` INT NOT NULL AUTO_INCREMENT,
  `id_cat_rol` INT NOT NULL,
  `id_cat_navegacion` INT NOT NULL,
  `ctrl_fecha_create` DATETIME NULL,
  `ctrl_fecha_update` DATETIME NOT NULL,
  `ctrl_user_mod` INT NOT NULL,
  PRIMARY KEY (`id_navegacion_roles`),
  INDEX `fk_cat_rol_idx` (`id_cat_rol` ASC) VISIBLE,
  INDEX `fk_cat_navegacion_idx` (`id_cat_navegacion` ASC) VISIBLE,
  CONSTRAINT `fk_cat_rol`
    FOREIGN KEY (`id_cat_rol`)
    REFERENCES `bdconectate`.`cat_rol` (`id_cat_rol`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cat_navegacion`
    FOREIGN KEY (`id_cat_navegacion`)
    REFERENCES `bdconectate`.`cat_navegacion` (`id_cat_navegacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
